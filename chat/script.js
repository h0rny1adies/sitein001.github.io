// Home: https://github.com/heysafronov/mangosteen-chat
...
! function (e) {
                    ...
                    function n(t) {
                        ...
                        n.readAsDataURL(t), n.onloadend = function () {
                            if ("image/jpeg" === t.type || "image/png" === t.type || "image/gif" === t.type) {
                                ...
                                r.src = "https://raw.githubusercontent.com/heysafronov/mangosteen-chat/master/src/assets/img/doc.png", r.classList.add("message__newImg"), e.appendChild(r)
                            }
                        }
                    }
    ...
    var v = function () {
            function e(t) {
                ...
                ! function (e, t) {
                    ...
                    avatar: "https://raw.githubusercontent.com/heysafronov/mangosteen-chat/master/src/assets/img/mark.png"
                }
            }
            return p(e, [{
                key: "template",
    ...
    new k("chat.json").getMessages().then(function (e) {
